...
\vspace{-0.1in}
\centering
\includegraphics[width=0.35\textwidth]{svd_speedup}
\vspace{-0.1in}
...
\vspace{-0.15in}
\centering
\includegraphics[width=0.35\textwidth]{compare_value_kernel}
\vspace{-0.1in}
...
\begin{figure}[hbpt]
\centering
\includegraphics[width=0.35\textwidth]{transaction}
\vspace{-0.1in}
...
\vspace{-0.1in}
\centering
\includegraphics[width=0.35\textwidth]{tolerance}
\vspace{-0.1in}
...
\vspace{-0.1in}
\centering
\includegraphics[width=0.35\textwidth]{ortho_err}
\vspace{-0.1in}
